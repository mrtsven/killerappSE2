...
define('subpages/profile',["require", "exports", "aurelia-framework", "aurelia-fetch-client", "aurelia-event-aggregator", "aurelia-authentication", "aurelia-router", "../Character", "jwt-decode"], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1, aurelia_event_aggregator_1, aurelia_authentication_1, aurelia_router_1, Character_1, jwt_decode) {
    ...
    var profile = (function () {
        ...
        profile.prototype.getArmor = function () {
            return __awaiter(this, void 0, void 0, function () {
                var data, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4, this.http.fetch('inventory/getarmor', {
                                body: aurelia_fetch_client_1.json({
                        ...
                        case 1:
                            ...
                            return [4, data.json()];
                        case 2:
                            _a.inventoryArmor = _b.sent();
                            return [2];
                    }
                });
            });
        };
        profile.prototype.getWeapon = function () {
            return __awaiter(this, void 0, void 0, function () {
                var data, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4, this.http.fetch('inventory/getweapon', {
                                body: aurelia_fetch_client_1.json({
                                    "item1": jwt_decode(this.auth.getAccessToken()).userid
                                })
                            })];
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,

define('text!app.html', ['module'], function(module) { module.exports = "\n<template bindable=\"router\">\r\n  <require from=\"sweetalert/dist/sweetalert.css\"></require>\r\n  <div id=\"app\">\r\n    <div class=\"strip strip__top\"></div>\r\n    <nav class=\"navbar navbar-default navbar-static-top\">\r\n      <div class=\"container\">\r\n        <div class=\"navbar-header\">\r\n          <!-- Collapsed Hamburger -->\r\n          <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#app-navbar-collapse\">\r\n            <span class=\"sr-only\">Toggle Navigation</span>\r\n            <span class=\"icon-bar\"></span>\r\n            <span class=\"icon-bar\"></span>\r\n            <span class=\"icon-bar\"></span>\r\n          </button>\r\n          <a class=\"navbar-brand hidden-xs\" href=\"/\">\r\n            ${title}\r\n          </a>\r\n        </div>\r\n        <div class=\"collapse navbar-collapse\" id=\"app-navbar-collapse\">\r\n          <!-- Right Side Of Navbar -->\r\n          <ul class=\"nav navbar-nav navbar-right\">\r\n            <li role=\"presentation\"><a route-href=\"route: login\" show.bind=\"!authenticated\">Login</a></li>\r\n            <li role=\"presentation\"><a route-href=\"route: create\" show.bind=\"!authenticated\">Register</a></li>\r\n            <li role=\"presentation\"><a route-href=\"route: shop\" show.bind=\"authenticated\">Shop</a></li>\r\n            <li role=\"presentation\"><a route-href=\"route: subpage\" show.bind=\"authenticated\">NPC</a></li>\n            <li role=\"presentation\"><a route-href=\"route: profile\" show.bind=\"authenticated\">Profile</a></li>\n            <li role=\"presentation\"><a  href=\"#\" click.delegate=\"logout()\" show.bind=\"authenticated\">Logout</a></li>\r\n          </ul>\r\n        </div>\r\n      </div>\r\n    </nav>\r\n    <router-view></router-view>\r\n  </div>\r\n  <div id=\"footer\">\r\n    <p>KVAS 2017</p>\r\n  </div>\r\n  <div class=\"strip strip__footer\"></div>\r\n</template>\r\n"; });
...
define('text!subpages/profile.html', ['module'], function(module) { module.exports = "<template>\r\n    <div class=\"container\">\r\n      <div class=\"row\">\r\n        <div class=\"col-md-8 col-md-offset-2\">\r\n          <div class=\"panel panel-primary\">\r\n            <div class=\"panel-heading\">\r\n              <span>Character</span>\r\n            </div>\r\n            <div class=\"panel-body\">\r\n              <form class=\"form-horizontal\">\r\n                <h4>\r\n                  Name:${character.name}\r\n                  <br />\r\n                  Healthpoints:${character.healthPoints}\r\n                </h4>\r\n\r\n                <p>\n                  <span>Stats</span>\n                  <br />\r\n                  Stamina:${character.stamina}\r\n                  <br />\r\n                  Strength:${character.strength}\r\n                  <br />\r\n                  Intelligence:${character.intelligence}\r\n                  <br />\r\n                  Charisma:${character.charisma}\r\n                </p>\r\n              </form>\r\n            </div>\n            <div class=\"panel-heading\">\r\n              <span>Inventory Gold:${character.gold}</span>\r\n            </div>\r\n            <div class=\"panel-body\">\r\n              <form class=\"form-horizontal\">\n                <table class=\"table table-hover\">\r\n                  <tr>\r\n                    <th>Item</th>\r\n                    <th>Description</th>\r\n                    <th></th>\r\n                  </tr>\r\n                  <tr repeat.for=\"item of inventoryArmor\">\r\n                    <td>${item.name}</td>\r\n                    <td>${item.about}</td>\n                    <td>\r\n                      <a class=\"btn btn-default\" click.delegate=\"buyItem(item.id)\" role=\"button\"><span aria-hidden=\"true\"></span>Discard</a>\r\n                    </td>\r\n                  </tr>\n                  <tr repeat.for=\"item of inventoryWeapon\">\r\n                    <td>${item.name}</td>\r\n                    <td>${item.about}</td>\n                    <td>\r\n                      <a class=\"btn btn-default\" click.delegate=\"buyItem(item.id)\" role=\"button\"><span aria-hidden=\"true\"></span>Discard</a>\r\n                    </td>\r\n                  </tr>\r\n                </table>\r\n              </form>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n\n</template>"; });
